...
The way to count for Option 2 from above would be 1 * 3 * 1 = 3 ways. 
...
## Prior
So for each option, the more number of ways it makes the data observed possible, the higher its chance of being the true option. So now option 3 is clearly the most likley. (you may observe that option 2 and 3 were very close in BWB but become quite different in BWBB! Why would this happen? )
